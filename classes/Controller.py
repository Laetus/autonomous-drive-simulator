    ...
    def update(self, timestep):
        ...
        for vpos, vehicle in enumerate(self.__vehicles):
            ...
            if lastVehicle:
                ...
                # a new vehicle is created when the distance between the new vehicle and vehicle close to the horizon
                if self.__setup.get('cars').get('horizon') * self.__setup.get('lanes').get('spawn_parameter') < vehicle.get_position():
